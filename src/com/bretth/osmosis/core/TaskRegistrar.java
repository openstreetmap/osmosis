...
import com.bretth.osmosis.core.pgsql.common.v0_6.PostgreSqlDumpWriterFactory;
import com.bretth.osmosis.core.pgsql.common.v0_6.PostgreSqlTruncatorFactory;
import com.bretth.osmosis.core.pgsql.common.v0_6.PostgreSqlWriterFactory;
...
public class TaskRegistrar {
	...
	public static void initialize() {
		...
		TaskManagerFactory.register("write-pgsql", new com.bretth.osmosis.core.pgsql.common.v0_5.PostgreSqlWriterFactory());
		TaskManagerFactory.register("wp", new com.bretth.osmosis.core.pgsql.common.v0_5.PostgreSqlWriterFactory());
		TaskManagerFactory.register("truncate-pgsql", new com.bretth.osmosis.core.pgsql.common.v0_5.PostgreSqlTruncatorFactory());
		TaskManagerFactory.register("tp", new com.bretth.osmosis.core.pgsql.common.v0_5.PostgreSqlTruncatorFactory());
		...
		TaskManagerFactory.register("write-pgsql-dump", new com.bretth.osmosis.core.pgsql.common.v0_5.PostgreSqlDumpWriterFactory());
		TaskManagerFactory.register("wpd", new com.bretth.osmosis.core.pgsql.common.v0_5.PostgreSqlDumpWriterFactory());
		...
		TaskManagerFactory.register("write-pgsql-0.5", new com.bretth.osmosis.core.pgsql.common.v0_5.PostgreSqlWriterFactory());
		TaskManagerFactory.register("truncate-pgsql-0.5", new com.bretth.osmosis.core.pgsql.common.v0_5.PostgreSqlTruncatorFactory());
		...
		TaskManagerFactory.register("write-pgsql-dump-0.5", new com.bretth.osmosis.core.pgsql.common.v0_5.PostgreSqlDumpWriterFactory());
		...
		TaskManagerFactory.register("write-pgsql-0.6", new PostgreSqlWriterFactory());
		TaskManagerFactory.register("truncate-pgsql-0.6", new PostgreSqlTruncatorFactory());
		...
		TaskManagerFactory.register("write-pgsql-dump-0.6", new PostgreSqlDumpWriterFactory());
