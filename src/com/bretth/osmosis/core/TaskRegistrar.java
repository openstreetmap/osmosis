...
public class TaskRegistrar {
	...
	public static void initialize() {
		...
		TaskManagerFactory.register("write-pgsql-simple", new com.bretth.osmosis.core.pgsql.v0_5.PostgreSqlDatasetWriterFactory());
		TaskManagerFactory.register("wps", new com.bretth.osmosis.core.pgsql.v0_5.PostgreSqlDatasetWriterFactory());
		TaskManagerFactory.register("truncate-pgsql-simple", new com.bretth.osmosis.core.pgsql.v0_5.PostgreSqlDatasetTruncatorFactory());
		TaskManagerFactory.register("tps", new com.bretth.osmosis.core.pgsql.v0_5.PostgreSqlDatasetTruncatorFactory());
		TaskManagerFactory.register("write-pgsql-simple-dump", new com.bretth.osmosis.core.pgsql.v0_5.PostgreSqlDatasetDumpWriterFactory());
		TaskManagerFactory.register("wpsd", new com.bretth.osmosis.core.pgsql.v0_5.PostgreSqlDatasetDumpWriterFactory());
		TaskManagerFactory.register("read-pgsql-simple", new com.bretth.osmosis.core.pgsql.v0_5.PostgreSqlDatasetReaderFactory());
		TaskManagerFactory.register("rps", new com.bretth.osmosis.core.pgsql.v0_5.PostgreSqlDatasetReaderFactory());
		TaskManagerFactory.register("write-pgsql-simple-change", new com.bretth.osmosis.core.pgsql.v0_5.PostgreSqlChangeWriterFactory());
		TaskManagerFactory.register("wpsc", new com.bretth.osmosis.core.pgsql.v0_5.PostgreSqlChangeWriterFactory());
		...
		TaskManagerFactory.register("write-pgsql-simple-0.5", new com.bretth.osmosis.core.pgsql.v0_5.PostgreSqlDatasetWriterFactory());
		TaskManagerFactory.register("truncate-pgsql-simple-0.5", new com.bretth.osmosis.core.pgsql.v0_5.PostgreSqlDatasetTruncatorFactory());
		TaskManagerFactory.register("write-pgsql-simple-dump-0.5", new com.bretth.osmosis.core.pgsql.v0_5.PostgreSqlDatasetDumpWriterFactory());
		TaskManagerFactory.register("read-pgsql-simple-0.5", new com.bretth.osmosis.core.pgsql.v0_5.PostgreSqlDatasetReaderFactory());
		TaskManagerFactory.register("write-pgsql-simple-change-0.5", new com.bretth.osmosis.core.pgsql.v0_5.PostgreSqlChangeWriterFactory());
