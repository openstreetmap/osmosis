...
/**
 * Reads current segments from a database ordered by their identifier.
 * 
 * @author Brett Henderson
 */
public class CurrentSegmentReader extends BaseEntityReader<Segment> {
	 ...
	 */
	public CurrentSegmentReader(String host, String database, String user, String password, boolean readAllUsers) {
