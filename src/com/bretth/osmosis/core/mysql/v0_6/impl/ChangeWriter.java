...
public class ChangeWriter {
	...
	private static final String DELETE_SQL_NODE_TAG =
		"DELETE FROM node_tags WHERE id = ? AND version = ?";
	...
	private static final String DELETE_SQL_WAY_TAG =
		"DELETE FROM way_tags WHERE id = ? AND version = ?";
	...
	private static final String DELETE_SQL_WAY_NODE =
		"DELETE FROM way_nodes WHERE id = ? AND version = ?";
	...
	private static final String DELETE_SQL_RELATION_TAG =
		"DELETE FROM relation_tags WHERE id = ? AND version = ?";
	 ...
	 * 
	 * @param statement
	 *            The statement used to perform the check.
	 * @param id
