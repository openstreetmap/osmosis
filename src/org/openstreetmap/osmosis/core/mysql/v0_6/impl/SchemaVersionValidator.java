...
public class SchemaVersionValidator {
	...
	/**
	 * Validates that the schema migrations match the expected list of
	 * migrations. This method caches the result allowing it to be called
	 * multiple times without a performance penalty.
	 * 
