...
public class ChangesetManager implements Releasable {
    ...
    /**
     * Defines the maximum number of entities that a single changeset may contain.
     */
    private static final int MAX_ENTITY_COUNT = 50000;

    private static final String SQL_INSERT_CHANGESET = "INSERT INTO changesets"
            + " (user_id, created_at, min_lat, max_lat, min_lon, max_lon, closed_at, num_changes)" + " VALUES"
    ...
    private final Map<Integer, ActiveChangeset> userToChangesetMap;
    ...
    /**
     * Creates and maintains a changeset for the specified user. If a changeset already exists for
     * that user it will be re-used.
     * 
