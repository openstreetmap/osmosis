...
/**
 * Provides the base implementation of all database entity readers. This extends the base table
 * reader with additional features used by top level entity readers.
 * 
 * @author Brett Henderson
 * @param <T> The type of entity to retrieved.
 */
public abstract class BaseEntityReader<T> extends BaseTableReader<T> {
     ...
     * provided.
     * 
     * @param dataPublic The value of the public edit flag for the user.
