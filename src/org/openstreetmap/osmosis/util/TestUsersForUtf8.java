...
/**
 * Very basic app for reading the user table and checking if all records are in double encoded UTF8
 * format. This is only useful on the production database where the data is incorrectly doubly
 * encoded. On a proper installation, this is unnecessary.
 * 
...
public class TestUsersForUtf8 {
    ...
    private static void run(String[] args) throws Exception {
        ...
        credentials = new DatabaseLoginCredentials(args[argIndex++], args[argIndex++], args[argIndex++],
                args[argIndex++], false, false, DatabaseType.POSTGRESQL);
