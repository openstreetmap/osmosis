...
public class IntervalExtractor {
    ...
    public void run() {
        ...
        reader = new ApidbChangeReader(new DatabaseLoginCredentials(config.getHost(), config.getDatabase(), config
                .getUser(), config.getPassword(), false, false, config.getDbType()), new DatabasePreferences(config
